...
interface EditStep2Props {
  ...
  digitalFileProgress: Record<string, number>;

  digitalFileUploading: Record<string, boolean>;
...
export default function EditStep2({
  ...
  const getFileKey = (
    ...
    return (
      file.uri ||
      `${file.name || "file"}-${file.size || 0}-${index}`
    );
  };
