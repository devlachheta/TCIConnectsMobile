...
//   const chunkFile = new File(Paths.cache, chunkName);
...
//   const sourceHandle = sourceFile.open(FileMode.ReadOnly);
//   const chunkHandle = chunkFile.open(FileMode.WriteOnly);

//   try {
//     sourceHandle.offset = start;

//     const bytes = await sourceHandle.readBytes(length);

//     if (bytes.length !== length) {
//       throw new Error(
//         `Expected ${length} bytes but read ${bytes.length} bytes`
//       );
//     }

//     await chunkHandle.writeBytes(bytes);
...
//     /**
//      * If tempPath is not provided,
//      * upload the file using the existing
//      * resumable/chunk upload system.
//      */
//     if (!filePath) {
...
//     if (!filePath) {
//       throw new Error(
//         "File upload completed but file path was not returned."
//       );
//     }

//     /**
//      * Now attach the uploaded temporary file
//      * to the case.
//      */
//     const response = await api.post(
